...
| FrodoPIR | 2a | Client downloads global LWE hint matrix M = A*D (5.5-6.3 MB); resolves old Group A to Group C cross-filing | [Protocol Phases](Group.2a.Download.Hint/frodopir_2022/frodopir_2022_notes.md#protocol-phases), paper p.14 (Table 2) |
...
| ThorPIR | 2b | Client-dependent FHE preprocessing: server homomorphically shuffles DB under client's BFV key; resolves old Group A+D hybrid classification | [Protocol Phases](Group.2b.Interactive.Hint/thorpir_2024/thorpir_2024_notes.md#protocol-phases), paper p.6-7 (Section 3) |
