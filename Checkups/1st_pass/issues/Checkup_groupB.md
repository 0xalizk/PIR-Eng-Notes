...
- **[\[^2\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/hintlesspir_2023/HintlessPIR_2023_notes.md#user-content-fn-2-c7b4cf6138067adadc6ee61aeb9b0fe4):** The quoted sentence is substantively correct and appears on p.9, but the quote is truncated -- the actual sentence continues with "than HintlessPIR, while also being slower by constant factors." The truncation does not change the meaning but the quote marks suggest a verbatim extraction.

- **[\[^19\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/hintlesspir_2023/HintlessPIR_2023_notes.md#user-content-fn-19-c7b4cf6138067adadc6ee61aeb9b0fe4):** The notes transcribe the three correctness conditions from Lemma 19 (p.46) but omit the "1+" inside the logarithm in conditions (2) and (3). The PDF has `ln(1 + k(n_rows+n)/(delta/3))` and `ln(1 + kn*ceil(n_rows/n)/(delta/3))` while the notes drop the "1+". Minor transcription error that does not materially affect meaning.

- **[\[^33\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/hintlesspir_2023/HintlessPIR_2023_notes.md#user-content-fn-33-c7b4cf6138067adadc6ee61aeb9b0fe4):** The footnote cites "Appendix B, after Lemma 11 (p.40)" but the specific sentence about "kappa = omega(log n)" for NTTlessPIR appears on p.42 in Appendix E, not in Appendix B. The general kappa framework is introduced after Lemma 11 on p.40, but the NTTlessPIR-specific instantiation is in a different appendix.
...
- **[\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-4-3043694a5bacd65536b72bf7bb0d5ca8):**
...
- **[\[^14\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-14-3043694a5bacd65536b72bf7bb0d5ca8):**
...
- **[\[^16\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-16-3043694a5bacd65536b72bf7bb0d5ca8):** The footnote quotes the asymptotic improvement as "n/log n" but the paper uses "d/log d" (where d is the lattice dimension). Same mathematical concept, different variable name.

- **[\[^43\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-43-3043694a5bacd65536b72bf7bb0d5ca8):** The footnote is factually accurate about Remark 4.1's content (ring-based SimplePIR incurs 3.6x throughput reduction), but is cited in the notes body text under "Memory bandwidth bound" to support a claim about YPIR being bounded by memory bandwidth. Remark 4.1 is actually about why YPIR does NOT use ring-based SimplePIR -- slightly misleading contextual use of an otherwise accurate citation.

- **[\[^15\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-15-3043694a5bacd65536b72bf7bb0d5ca8):** States "Section 4.4 (p.21)" but the relevant preprocessing cost text spans the bottom of p.21 into p.22.

- **Body text referencing [\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-4-3043694a5bacd65536b72bf7bb0d5ca8):** The body text claims "7--14x smaller responses" for YPIR+SP vs HintlessPIR, but this ratio only holds for 1 GB and 8 GB databases with 32 KB records, not for the 32 GB x 64 KB configuration cited in the footnote.

- **Body text referencing [\[^33\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-33-3043694a5bacd65536b72bf7bb0d5ca8):** The body text says "1.4--1.7x effective throughput improvement" but the paper says "1.5--1.7x." The lower bound in the body text (1.4) does not match the paper (1.5).
...
- **[\[^29\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-29-8f8592d0931ab27eb519944135fb0614):**
...
- **[\[^8\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-8-8f8592d0931ab27eb519944135fb0614):** Content about the correctness condition is accurate but appears at top of p.5, not p.4 as cited.

- **[\[^19\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-19-8f8592d0931ab27eb519944135fb0614):** The relinearization description is from Section 2.2 (p.4), not Section 3.3 (p.8) as cited. Content is substantively correct; section/page citation is wrong.

- **[\[^22\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-22-8f8592d0931ab27eb519944135fb0614):** Remark A.2 content is accurate but located on p.15, not p.14 as cited.

- **[\[^25\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-25-8f8592d0931ab27eb519944135fb0614):** Same as [\[^8\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-8-8f8592d0931ab27eb519944135fb0614) -- the correctness condition text is on p.5, not p.4 as cited.
...
- **[\[^44\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-44-8f8592d0931ab27eb519944135fb0614):** The blocklist database description is cited as Section 5 (p.12), but the specific text about "2^24 entries... 32-byte hash... roughly 1 GB" appears on p.13, not p.12.
...
- **[\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-4-1cbec9417da89c3cbf0fb558d3b63c52):**
...
- **[\[^16\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-16-1cbec9417da89c3cbf0fb558d3b63c52):**
...
- **[\[^35\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-35-1cbec9417da89c3cbf0fb558d3b63c52):**
...
- **[\[^2\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-2-1cbec9417da89c3cbf0fb558d3b63c52):** Footnote quote is accurate ("reduce the query size from 14 KB to 4 KB"). Notes body adds "~" before "4 KB" not present in the original.

- **[\[^5\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-5-1cbec9417da89c3cbf0fb558d3b63c52):** Notation is slightly simplified but substance is correct. External product formula matches.

- **[\[^22\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-22-1cbec9417da89c3cbf0fb558d3b63c52):** Reduction ratios are approximately correct; "8.5x" should be ~8.6x (minor rounding).

- **[\[^34\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-34-1cbec9417da89c3cbf0fb558d3b63c52):** Footnote quote is accurate ("26% slower"), but actual Table 1 numbers yield ~35% slower (20.84s vs 15.44s). The notes faithfully reproduce the paper's own approximation.

- **[\[^33\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/respire_2024/Respire_2024_notes.md#user-content-fn-33-1cbec9417da89c3cbf0fb558d3b63c52):** Footnote quote is accurate. Notes body interprets the paper's "a few KB" as "~2 KB" -- reasonable but imprecise paraphrase.
...
- **[\[^8\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-8-1aaa1ac75204571b31d9a1802ce1dfd8):**
...
- **[\[^3\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-3-1aaa1ac75204571b31d9a1802ce1dfd8):** Inline claim that InsPIRe_0 "only supports small entry sizes (e.g., 1 bit)" overstates the cited Section 4 (p.12) text, which says "useful when the entry size is small." The stronger "only supports" claim appears on p.18, not p.12.

- **[\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-4-1aaa1ac75204571b31d9a1802ce1dfd8):** Inline claim that InsPIRe^(2) "lacks the polynomial evaluation technique" is the notes' own characterization not found at cited Section 5 (p.12).

- **[\[^23\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-23-1aaa1ac75204571b31d9a1802ce1dfd8):** Notes say "All runtimes averaged over 5 runs (standard deviation < 5%)." The PDF actually distinguishes: offline runtimes measured once, only online runtimes averaged over 5 runs.

- **[\[^24\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-24-1aaa1ac75204571b31d9a1802ce1dfd8):** Notes say "Built on RLWE building blocks from spiral-rs (YPIR implementation)." The PDF distinguishes spiral-rs (a separate RLWE library) from the YPIR implementation (a distinct codebase). The parenthetical conflates them.

- **[\[^26\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-26-1aaa1ac75204571b31d9a1802ce1dfd8):** Footnote quote is verbatim correct, but the inline summary preceding it misassigns the percentage comparisons between HintlessPIR and CDKS targets.

- **[\[^26\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-26-1aaa1ac75204571b31d9a1802ce1dfd8) (continued):** Inline "28% faster online time than CDKS" comes from the d=11 parameter set (40 ms vs 56 ms), continuing the pattern of mixing d=10 and d=11 figures seen in [\[^8\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/inspire_2025/InsPIRe_2025_notes.md#user-content-fn-8-1aaa1ac75204571b31d9a1802ce1dfd8).
...
- **[\[^2\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-2-8107ded82fd68762768e920e1ddc3923):**
...
- **[\[^10\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-10-8107ded82fd68762768e920e1ddc3923):**
...
- **[\[^24\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-24-8107ded82fd68762768e920e1ddc3923):**
...
- **[\[^3\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-3-8107ded82fd68762768e920e1ddc3923):** The 420x figure is from the abstract and is an approximation; 14.8 KB / 36 B = 410x, not 420x. The notes faithfully reproduce the paper's rounded value.

- **[\[^5\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-5-8107ded82fd68762768e920e1ddc3923):** The quote "from 36 B to 60 B" is accurate for the 2^25 case. Table 7 shows variation across database sizes (55--60 B), which the notes use elsewhere.

- **[\[^12\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-12-8107ded82fd68762768e920e1ddc3923):** The notes quote "2^{v_3} records" but the PDF text uses "N/N_1 records" (mathematically equivalent but not a direct quote).

- **[\[^18\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-18-8107ded82fd68762768e920e1ddc3923):** The quoted text says "around 3 KB" while Table 7 shows 2 KB. The notes use "~2 KB" as the primary figure while quoting "around 3 KB." Acknowledged in the Uncertainties section.

- **[\[^22\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-22-8107ded82fd68762768e920e1ddc3923):** The "LWEtoRGSW dominates Phase 0 time" characterization of Figure 3 is directionally correct but slightly overstated -- LWEtoRGSW is the largest component but not overwhelmingly dominant.

- **[\[^25\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-25-8107ded82fd68762768e920e1ddc3923):** The quoted passage describes BasicBitDecomp reducing to "just one" BlindRotate, while the notes claim "3 * ceil(k/v)" which comes from a different part of Section 3.1. Minor attribution imprecision.
...
- **[\[^1\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-1-9b60cdc6ca80bbc513be0ffd3352efb4):**
...
- **[\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-4-9b60cdc6ca80bbc513be0ffd3352efb4):**
...
- **[\[^3\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-3-9b60cdc6ca80bbc513be0ffd3352efb4):** The formula "l*log(IJn_1/n_2) = l*log N" is cited as Section 1.1 (p.4), but the exact formula appears on p.13 (Section 4.2). Page 4 has only the general O(log N) statement.

- **[\[^7\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-7-9b60cdc6ca80bbc513be0ffd3352efb4):** The DMux formula notation (c - C box c) is from the 1-to-2 DMux definition, not explicitly restated in Algorithm 2 as cited.

- **[\[^13\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-13-9b60cdc6ca80bbc513be0ffd3352efb4):** The two listed q_{1,1} factors for VIA both appear identical (268369921) in the PDF, which would give ~2^56 not ~2^57 as claimed. Likely a PDF rendering artifact; the notes faithfully reproduce the PDF's values.

- **[\[^17\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-17-9b60cdc6ca80bbc513be0ffd3352efb4):** Content correct but cited as Section 4.2 (p.13); the query compression details span p.12-13.

- **[\[^22\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-22-9b60cdc6ca80bbc513be0ffd3352efb4):** States "VIA-C adds CRot (step 6) and response compression (step 7)" but omits that VIA-C also adds query decompression (step 1). Incomplete characterization of the differences.

- **[\[^25\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-25-9b60cdc6ca80bbc513be0ffd3352efb4):** Content about first-dimension dominance is correct but the characterization is slightly simplified compared to the PDF's discussion of the 2x cost difference stemming from modulus sizes.

- **[\[^31\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-31-9b60cdc6ca80bbc513be0ffd3352efb4):** The 3.5x query and 127x response reductions are numerically correct from Table 2, but the PDF attributes these to "tiny record databases" generically, not specifically "1 GB at T=256" as the notes imply.
...
|---|-------|----|-------------|
| 1 | YPIR | [\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-4-3043694a5bacd65536b72bf7bb0d5ca8) | HintlessPIR download claimed as 3.2 MB at 32 GB x 64 KB; actual Table 7 value is 724 KB |
| 2 | YPIR | [\[^14\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/ypir_2024/YPIR_2024_notes.md#user-content-fn-14-3043694a5bacd65536b72bf7bb0d5ca8) | YPIR upload/download figures swapped with SimplePIR's and DoublePIR's values |
| 3 | WhisPIR | [\[^29\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/whispir_2024/WhisPIR_2024_notes.md#user-content-fn-29-8f8592d0931ab27eb519944135fb0614) | Table 1 rotation counts misattributed across rows (d=1024 value assigned to d=2048) |
...
| 13 | Pirouette | [\[^24\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/pirouette_2025/Pirouette_2025_notes.md#user-content-fn-24-8107ded82fd68762768e920e1ddc3923) | Claims "exact transcriptions" but parallel table has offline comm (91 MB) in computation rows |
| 14 | VIA | [\[^1\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-1-9b60cdc6ca80bbc513be0ffd3352efb4) | Fabricated primacy claim not present in the cited abstract |
| 15 | VIA | [\[^4\]](../../../Schemes/Group%20B%20-%20Stateless%20Single%20Server%20PIR/via_2025/VIA_2025_notes.md#user-content-fn-4-9b60cdc6ca80bbc513be0ffd3352efb4) | HintlessPIR total is 18578 KB, not 10578 KB (dropped leading digit) |
