...
```
 ...
 ║    (one is non-null, one is null — resolved by adapter Schema Router)  ║
 ╚════════╪════╪═══════════╪════╪═══════════╪════╪═══════════╪════╪═══════╝
          │    │           │    │           │    │           │    │
          ▼    ▼           ▼    ▼           ▼    ▼           ▼    ▼
 ╔═══════════════════════════════════════════════════════════════════════════╗
 ...
 ║                                                                         ║
 ║    query(idx) on Main   ──►  answer₁  (non-null if key in snapshot)    ║
 ║    query(idx) on Sidecar ──► answer₂  (non-null if key updated recently)║
 ║                                                                         ║
 ║    Exactly one of {answer₁, answer₂} is non-null for any given key.   ║
